...
from models.modules.deform_conv_v2 import DeformConv2d
...
class ConvBlock(nn.Module):
    def __init__(self,in_channels,out_channels,kernel = 3,strides = 1,padding=1,
        ...
        self.conv = DeformConv2d(inc=in_channels,outc=out_channels,

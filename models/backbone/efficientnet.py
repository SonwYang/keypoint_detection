...
from models.backbone._base import EncoderMixin
...
if __name__ == '__main__':
    import torch
    params = efficient_net_encoders["efficientnet-b6"]["params"]
    encoder = EfficientNetEncoder(**params)
